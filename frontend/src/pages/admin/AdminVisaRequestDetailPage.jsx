...
function AdminVisaRequestDetailPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <Link to="/admin/visa-requests" className="text-sm font-medium text-primary-600 hover:text-primary-700">
        &larr; Back to visa requests
      </Link>

      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-neutral-900">{visaRequest.applicationNumber}</h1>
